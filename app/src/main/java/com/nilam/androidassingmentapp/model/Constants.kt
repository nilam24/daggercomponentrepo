...
class Constants @Inject constructor() {
    var list = ArrayList<MediaItem>()
     ...
     fun setMediaDataList(): List<MediaItem> {
        ...
        mediaItem.url = "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"
        ...
        mediaItem2.url = "https://uds.ak.o.brightcove.com/5384493731001/5384493731001_5552873278001_5552856451001.mp4?pubId=5384493731001&videoId=5552856451001"
        ...
        mediaItem3.url = "http://manifest.prod.boltdns.net/manifest/v1/hls/v4/clear/5384493731001/9ae886bf-c6e9-4b7d-94be-afaa7c848d7a/10s/master.m3u8?fastly_token=NWY0ZmE1OTBfNjVkN2ZlY2JkN2RhNTgzM2RhMjUxZjU5ZGJlZTU0MTFlYTMxY2I0ODljNzI5ZjJmYTYxNjUxOWFjN2I3NDVlYg%3D%3D"
        ...
        mediaItem5.title = "Nation Wants To Know: Union minister Col Rajyavardhan Rathore Speaks To Arnab"
        mediaItem5.url =
